...
for param in range(8):
    for char in range(6): 
        generate(latent_parameters_lists[param],characteristics_lists[char],"[28_03_16_46] Latent Parameter "+ str(param)+" and characteristic "+ str(char), "Latent Parameter", "Characteristic "+ str(param))
