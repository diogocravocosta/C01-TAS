...
def generate(x,y,Title, x_label, y_label):
    ...
    y_array_cubic = regress_quadratic[0] * x_array**2 + regress_quadratic[1] * x_array + regress_quadratic[2]
    ...
    ax.plot(x_array, y_array_cubic, label = "Cubic $R^2$ ="+ str(round(regress_cubic[4], 4)))
    ax.legend()
